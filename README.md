...
To update the database use this command from the Web project folder (replace `FreeMindLabs.IntelliBlog` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../FreeMindLabs.IntelliBlog.Infrastructure/FreeMindLabs.IntelliBlog.Infrastructure.csproj -s FreeMindLabs.IntelliBlog.Web.csproj
```
